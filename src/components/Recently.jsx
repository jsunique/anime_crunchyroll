...
export default function Recently() {
  ...
  const url = `https://kitsu.io/api/edge/anime?page[limit]=20&page[offset]=${(page - 1)*20}&sort=-updatedAt`
  useEffect(()=>{
    sendRequest();
  },[page]);
  ...
  return (
    <>
    {
      ...
      <div className='flex mt-8 gap-3  flex-col mb-25'>
        <p className='text-center text-primary font-pop sm:text-xl  md:text-2xl  '>All Anime</p>
